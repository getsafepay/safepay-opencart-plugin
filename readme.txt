...
With this extension you can accept payments using Safepay Payment Gateway. Safepay is an embeddable payment form for desktop, tablet, and mobile devices. It offers payment options that make it easy for shoppers to pay the way they want without being redirected away to complete the transaction. Perfect for any store.


INSTALLATION.

If this is your first install of the module, and you are not upgrading to the latest version, follow this steps to install the extension.

- Always make a backup of your site before install new modules or extensions.
...
- Go to, Extensions > Payments  and click on install button, next to "Safepay".
- Go to, Extensions > Payments. Click on edit button, next to "Safepay".
- You are ready to setup your credentials and settings and start using safepay


UPGRADE.

If this is not your first install of the module, and you are just upgrading to the latest version, follow this steps to upgrade the extension.
